import "./HorizontalFiltration.css"
...
function HorizontalFiltration() {
  ...
  return (
    <div className="filtration2">
      <div className="menu">
        <span></span>
        <span></span>
        <span></span>
      </div>
      <div className="filtration-header2">
        <div className="header-vehicle2" onClick={() => {handlevehicle(0, "car 🚗")}}>
        ...
        <div className="header-vehicle2" onClick={() => {handlevehicle(25, "truck 🚐")}}>
        ...
        <div className="header-vehicle2" onClick={() => {handlevehicle(50, "bike 🚲")}}>
        ...
        <div className="header-vehicle2" onClick={() => {handlevehicle(75, "scooter 🏍️")}}>
        ...
        <div className="actual2" style={{left: `${selectedVehicle}%`}}></div>
      </div>
      <h2>Find your dream {selectedVehicleText}</h2>
      <div className="filtration-wrapper2">
        <section>
          <label>Brand</label>
      ...
      <div className="filtration-wrapper2">
        ...
        <button className="filtration-btn2">
...
export default HorizontalFiltration